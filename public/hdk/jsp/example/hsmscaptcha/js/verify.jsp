<%
  ...
  String HSMSCaptchaRemoteAddr = request.getParameter("HSMSCaptchaRemoteAddr");
  String SecurityPath = (request.getSession().getServletContext().getRealPath("/") + "hdk/jsp/security/hinsite").replaceAll("\\\\","/");
	...
	String ReturnString = HSMSCaptchaObj.Verify("https://api.hinsite.com/default.php?&u=hsmscaptcha&s=verify", PrivateKey, HSMSCaptchaTel, HSMSCaptchaRemoteAddr, new String(HSMSCaptchaValue.getBytes("ISO-8859-1"), "UTF-8"));
